...
/// Page limits, request fields and conflicts, per route. Some lists clamp an
/// out-of-range limit instead of refusing it; the table pins which.
#[sqlx::test(migrator = "server::database::MIGRATOR")]
#[ignore = "requires a PostgreSQL server with DATABASE_URL"]
...
const ROUTES: &[Case] = &[
    ...
    Case {
        ...
        body: None,
        expect: [Error(401, "invalid_credential", "authentication required"), Error(503, "installation_metadata_unavailable", "agent installation metadata is unavailable"), Error(503, "installation_metadata_unavailable", "agent installation metadata is unavailable"), Error(503, "installation_metadata_unavailable", "agent installation metadata is unavailable"), Error(401, "invalid_credential", "authentication required")],
    },
    Case {
        method: "GET",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/installations",
        body: None,
        expect: [Error(401, "invalid_credential", "authentication required"), Error(404, "not_found", "resource not found"), Error(404, "not_found", "resource not found"), Ok(200), Error(401, "invalid_credential", "authentication required")],
    },
    Case {
        method: "POST",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/installations",
        body: Some(r#"{"cluster_name":"cluster","workload":{"namespace":"production","kind":"Deployment","name":"app"}}"#),
        expect: [Error(401, "invalid_credential", "authentication required"), Error(404, "not_found", "resource not found"), Error(404, "not_found", "resource not found"), Error(503, "installation_metadata_unavailable", "agent installation metadata is unavailable"), Error(401, "invalid_credential", "authentication required")],
    },
    Case {
        method: "GET",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/installations/{installation_id}",
        body: None,
        expect: [Error(401, "invalid_credential", "authentication required"), Error(404, "not_found", "resource not found"), Error(404, "not_found", "resource not found"), Error(404, "not_found", "resource not found"), Error(401, "invalid_credential", "authentication required")],
    },
    Case {
        method: "PATCH",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/installations/{installation_id}",
    ...
    Case {
        ...
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Ok(201)],
    },
    Case {
        method: "GET",
        uri: "/api/v1/admin/organizations",
        body: None,
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Ok(200)],
    },
    Case {
        method: "GET",
    ...
    Case {
        ...
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "organization_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Ok(201), Error(409, "project_slug_conflict", "resource already exists")],
    },
    Case {
        method: "POST",
        uri: "/api/v1/projects/{project_id}/applications",
        body: Some(r#"{"slug":"created-app","name":"Created"}"#),
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "project_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Ok(201), Error(409, "application_slug_conflict", "resource already exists")],
    },
    Case {
        method: "GET",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/credentials",
        body: None,
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "application_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Ok(200), Ok(200)],
    },
    Case {
        method: "POST",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/credentials",
        body: Some(r#"{"name":"ci"}"#),
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "application_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Ok(201), Error(409, "credential_name_conflict", "resource already exists")],
    },
    Case {
        method: "DELETE",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/credentials/{credential_id}",
        body: None,
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "application_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Error(404, "credential_not_found", "resource not found"), Error(404, "credential_not_found", "resource not found")],
    },
    Case {
        method: "GET",
    ...
    Case {
        ...
        uri: "/api/v1/platform/projects/{project_id}/applications/{application_id}/credentials",
        body: Some(r#"{"name":"ci"}"#),
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "application_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Error(409, "credential_name_conflict", "resource already exists"), Error(409, "credential_name_conflict", "resource already exists")],
    },
    Case {
        method: "DELETE",
...
const INVALID: &[Case] = &[
    ...
    Case {
        ...
        body: None,
        expect: [Error(401, "unauthorized", "authentication required"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Error(400, "validation_failed", "limit must be between 1 and 100")],
    },
    Case {
        method: "GET",
    ...
    Case {
        ...
        body: None,
        expect: [Error(401, "unauthorized", "authentication required"), Error(404, "organization_not_found", "resource not found"), Error(403, "forbidden", "insufficient permission"), Error(400, "validation_failed", "limit must be between 1 and 100"), Error(400, "validation_failed", "limit must be between 1 and 100")],
    },
    Case {
        method: "GET",
    ...
    Case {
        ...
        body: None,
        expect: [Error(401, "unauthorized", "authentication required"), Error(404, "project_not_found", "resource not found"), Error(404, "project_not_found", "resource not found"), Error(400, "validation_failed", "limit must be between 1 and 100"), Error(400, "validation_failed", "limit must be between 1 and 100")],
    },
    Case {
        method: "GET",
    ...
    Case {
        ...
        uri: "/api/v1/organizations/{organization_id}/projects",
        body: Some(r#"{"slug":"Bad Slug","name":"New"}"#),
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(404, "organization_not_found", "resource not found"), Error(403, "forbidden", "owner role is required"), Error(400, "validation_failed", "the request contains invalid fields"), Error(400, "validation_failed", "the request contains invalid fields")],
    },
    Case {
        method: "POST",
        uri: "/api/v1/projects/{project_id}/applications",
        body: Some(r#"{"slug":"Bad Slug","name":"New"}"#),
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(400, "validation_failed", "the request contains invalid fields"), Error(400, "validation_failed", "the request contains invalid fields"), Error(400, "validation_failed", "the request contains invalid fields"), Error(400, "validation_failed", "the request contains invalid fields")],
    },
    Case {
        method: "POST",
        uri: "/api/v1/organizations",
        body: Some(r#"{"slug":"Bad Slug","name":"New"}"#),
        expect: [Error(401, "invalid_credential", "invalid or missing bearer credential"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Error(403, "forbidden", "super administrator role is required"), Error(400, "validation_failed", "the request contains invalid fields")],
    },
    Case {
        method: "POST",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/credentials",
    ...
    Case {
        ...
        expect: [Error(401, "invalid_credential", "authentication required"), Error(404, "not_found", "resource not found"), Error(404, "not_found", "resource not found"), Error(400, "validation_failed", "cluster or workload identity is invalid"), Error(401, "invalid_credential", "authentication required")],
    },
    Case {
        method: "POST",
        uri: "/api/v1/projects/{project_id}/applications/{application_id}/installations",
